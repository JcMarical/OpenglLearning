...
int main()
{
    ...
    Shader explodeShader("ExplodeShader.vs", "ExplodeShader.fs", "ExplodeShader.gs");
    Shader normalShader("normalDisplayShader.vs", "normalDisplayShader.fs", "normalDisplayShader.gs");
